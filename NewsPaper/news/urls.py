...
urlpatterns = [
    ...
    path('<str:category>/<int:pk>', cache_page(300)(NewsCategoryView.as_view()), name='category_news'),
    ...
    path('<str:category>/<int:pk>', cache_page(300)(ArticleCategoryView.as_view()), name='category_article'),
